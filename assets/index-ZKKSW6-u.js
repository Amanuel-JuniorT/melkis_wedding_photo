...
function fo() {
  ...
  (Y.prototype.isReactComponent = {}),
    (Y.prototype.setState = function (b, C) {
  ...
  function nt(b, C, Z, L, F, ht) {
    return (
      (Z = ht.ref),
      { $$typeof: u, type: b, key: C, ref: Z !== void 0 ? Z : null, props: ht }
    );
  }
  function rt(b, C) {
    return nt(b.type, C, void 0, void 0, void 0, b.props);
  }
  function ot(b) {
  ...
  function Rt(b, C, Z, L, F) {
        ...
        case "object":
          switch (b.$$typeof) {
            ...
            case i:
              ...
              break;
            case E:
              return (tt = b._init), Rt(tt(b._payload), C, Z, L, F);
          }
      }
    if (tt)
      return (
    ...
    if (Q(b))
      for (var xt = 0; xt < b.length; xt++)
        (L = b[xt]), (ht = ee + st(L, xt)), (tt += Rt(L, C, Z, ht, F));
    else if (((xt = O(b)), typeof xt == "function"))
      for (b = xt.call(b), xt = 0; !(L = b.next()).done; )
        (L = L.value), (ht = ee + st(L, xt++)), (tt += Rt(L, C, Z, ht, F));
    else if (ht === "object") {
      if (typeof b.then == "function") return Rt(P(b), C, Z, L, F);
      throw (
        ((C = String(b)),
        Error(
  ...
  return (
    ...
    (lt.cloneElement = function (b, C, Z) {
      if (b == null)
        throw Error(
      ...
      return nt(b.type, F, void 0, void 0, ht, L);
    }),
    ...
    (lt.createElement = function (b, C, Z) {
      var L,
        F = {},
        ht = null;
      if (C != null)
      ...
      if (b && b.defaultProps)
        for (L in ((tt = b.defaultProps), tt))
          F[L] === void 0 && (F[L] = tt[L]);
      return nt(b, ht, void 0, void 0, null, F);
    }),
    ...
    (lt.memo = function (b, C) {
      return { $$typeof: v, type: b, compare: C === void 0 ? null : C };
    }),
    ...
    (lt.useActionState = function (b, C, Z) {
      return G.H.useActionState(b, C, Z);
    }),
    (lt.useCallback = function (b, C) {
    ...
    (lt.useDeferredValue = function (b, C) {
      return G.H.useDeferredValue(b, C);
    }),
    (lt.useEffect = function (b, C, Z) {
      var L = G.H;
      if (typeof Z == "function")
        throw Error(
          "useEffect CRUD overload is not enabled in this build of React."
        );
      return L.useEffect(b, C);
    }),
    (lt.useId = function () {
      return G.H.useId();
    }),
    (lt.useImperativeHandle = function (b, C, Z) {
      return G.H.useImperativeHandle(b, C, Z);
    }),
    (lt.useInsertionEffect = function (b, C) {
      return G.H.useInsertionEffect(b, C);
    }),
    (lt.useLayoutEffect = function (b, C) {
      return G.H.useLayoutEffect(b, C);
    }),
    (lt.useMemo = function (b, C) {
      return G.H.useMemo(b, C);
    }),
    (lt.useOptimistic = function (b, C) {
      return G.H.useOptimistic(b, C);
    }),
    (lt.useReducer = function (b, C, Z) {
      return G.H.useReducer(b, C, Z);
    }),
    ...
    (lt.useSyncExternalStore = function (b, C, Z) {
      return G.H.useSyncExternalStore(b, C, Z);
    }),
    ...
    r1 ||
      ...
      (function (u) {
        ...
        function c(U) {
          ...
          if (k !== j) {
            U[0] = k;
            t: for (var At = 0, b = U.length, C = b >>> 1; At < C; ) {
              var Z = 2 * (At + 1) - 1,
                L = U[Z],
                F = Z + 1,
                ht = U[F];
                  ...
                  e: {
                    for (
                      ...
                      if (typeof At == "function") {
                        ...
                        var b = At(z.expirationTime <= U);
                        if (((U = u.unstable_now()), typeof b == "function")) {
                          (z.callback = b), Q(U), (j = !0);
                          break e;
                        }
                        z === s(y) && c(y), Q(U);
                      } else c(y);
...
function oo() {
  ...
  function Z(t) {
    0 > b || ((t.current = At[b]), (At[b] = null), b--);
  }
  function L(t, e) {
    b++, (At[b] = t.current), (t.current = e);
  }
  var F = C(null),
    ht = C(null),
    tt = C(null),
...
` +
  ...
  var bl = {
    ...
    nu = kt(s0),
    c0 = E({}, bl, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    r0 = kt(c0),
    h0 = E({}, bl, {
  ...
  var S0 = E({}, za, {
    ...
    A0 = kt(E0),
    _0 = E({}, bl, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    M0 = kt(_0),
    T0 = E({}, Hi, {
      deltaX: function (t) {
        return "deltaX" in t
  ...
  function Uc(t) {
    ...
    if (((Pe = 0), (Ht = bt = at = null), (Fi = !1), (wa = 0), (aa = null), e))
      throw Error(c(300));
    t === null ||
      Lt ||
  ...
  function k0() {
    ...
    return (
      ...
      (t = t.useState()[0]),
      (bt !== null ? bt.memoizedState : null) !== t && (at.flags |= 1024),
      e
    );
  }
  function Xu() {
  ...
  function Lu(t) {
    ...
    (Pe = 0), (Ht = bt = at = null), (la = !1), (wa = Wi = 0), (aa = null);
  }
  function It() {
    var t = {
      memoizedState: null,
  ...
  function Gc(t, e, l, a) {
    return (t.baseState = l), Zu(t, bt, typeof a == "function" ? a : Ce);
  }
  ...
  function Ja(t, e, l, a) {
    ...
    bt !== null && a !== null && Cu(a, bt.memoizedState.deps)
  ...
  var en = {
    ...
    gr = {
      ...
      useDeferredValue: function (t, e) {
        var l = qt();
        return ir(l, bt.memoizedState, t, e);
      },
      useTransition: function () {
        var t = ki(Ce)[0],
          e = qt().memoizedState;
    ...
    ad = {
      ...
      useDeferredValue: function (t, e) {
        var l = qt();
        return bt === null ? Fu(l, t, e) : ir(l, bt.memoizedState, t, e);
      },
      useTransition: function () {
        var t = Vu(Ce)[0],
          e = qt().memoizedState;
  ...
  function vr(t) {
    ...
    function l(A, p) {
      if (!t) return null;
      for (; p !== null; ) e(A, p), (p = p.sibling);
      return null;
    }
    function a(A) {
      for (var p = new Map(); A !== null; )
        A.key !== null ? p.set(A.key, A) : p.set(A.index, A), (A = A.sibling);
      return p;
    }
    function n(A, p) {
      return (A = Ue(A, p)), (A.index = 0), (A.sibling = null), A;
    }
    function f(A, p, _) {
      return (
        (A.index = _),
        t
          ? ((_ = A.alternate),
            _ !== null
              ? ((_ = _.index), _ < p ? ((A.flags |= 67108866), p) : _)
              : ((A.flags |= 67108866), p))
          : ((A.flags |= 1048576), p)
      );
    }
    ...
    function d(A, p, _, N) {
      return p === null || p.tag !== 6
        ? ((p = Su(_, A.mode, N)), (p.return = A), p)
        : ((p = n(p, _)), (p.return = A), p);
    }
    function S(A, p, _, N) {
      var w = _.type;
      return w === B
        ? R(A, p, _.props.children, N, _.key)
        : p !== null &&
          (p.elementType === w ||
            (typeof w == "object" &&
              w !== null &&
              w.$$typeof === rt &&
              yr(w) === p.type))
        ? ((p = n(p, _.props)), $a(p, _), (p.return = A), p)
        : ((p = Gi(_.type, _.key, _.props, null, A.mode, N)),
          $a(p, _),
          (p.return = A),
          p);
    }
    function M(A, p, _, N) {
      return p === null ||
        ...
        ? ((p = bu(_, A.mode, N)), (p.return = A), p)
        : ((p = n(p, _.children || [])), (p.return = A), p);
    }
    function R(A, p, _, N, w) {
      return p === null || p.tag !== 7
        ? ((p = Al(_, A.mode, N, w)), (p.return = A), p)
        : ((p = n(p, _)), (p.return = A), p);
    }
    function H(A, p, _) {
      if (
        ...
        return (p = Su("" + p, A.mode, _)), (p.return = A), p;
      if (typeof p == "object" && p !== null) {
        switch (p.$$typeof) {
          case O:
            return (
              (_ = Gi(p.type, p.key, p.props, null, A.mode, _)),
              $a(_, p),
              (_.return = A),
              _
            );
          case D:
            return (p = bu(p, A.mode, _)), (p.return = A), p;
          case rt:
            var N = p._init;
            return (p = N(p._payload)), H(A, p, _);
        }
        if (Rt(p) || st(p))
          return (p = Al(p, A.mode, _, null)), (p.return = A), p;
        if (typeof p.then == "function") return H(A, ln(p), _);
        if (p.$$typeof === K) return H(A, Zi(A, p), _);
        an(A, p);
      }
      return null;
    }
    function T(A, p, _, N) {
      ...
      if (
        ...
        return w !== null ? null : d(A, p, "" + _, N);
      if (typeof _ == "object" && _ !== null) {
        switch (_.$$typeof) {
          case O:
            return _.key === w ? S(A, p, _, N) : null;
          case D:
            return _.key === w ? M(A, p, _, N) : null;
          case rt:
            return (w = _._init), (_ = w(_._payload)), T(A, p, _, N);
        }
        if (Rt(_) || st(_)) return w !== null ? null : R(A, p, _, N, null);
        if (typeof _.then == "function") return T(A, p, ln(_), N);
        if (_.$$typeof === K) return T(A, p, Zi(A, _), N);
        an(A, _);
      }
      return null;
    }
    function x(A, p, _, N, w) {
      if (
        (typeof N == "string" && N !== "") ||
        typeof N == "number" ||
        typeof N == "bigint"
      )
        return (A = A.get(_) || null), d(p, A, "" + N, w);
      if (typeof N == "object" && N !== null) {
        switch (N.$$typeof) {
          case O:
            return (
              (A = A.get(N.key === null ? _ : N.key) || null), S(p, A, N, w)
            );
          case D:
            return (
              (A = A.get(N.key === null ? _ : N.key) || null), M(p, A, N, w)
            );
          case rt:
            var it = N._init;
            return (N = it(N._payload)), x(A, p, _, N, w);
        }
        if (Rt(N) || st(N)) return (A = A.get(_) || null), R(p, A, N, w, null);
        if (typeof N.then == "function") return x(A, p, _, ln(N), w);
        if (N.$$typeof === K) return x(A, p, _, Zi(p, N), w);
        an(p, N);
      }
      return null;
    }
    function I(A, p, _, N) {
      for (
        var w = null, it = null, J = p, $ = (p = 0), Qt = null;
        J !== null && $ < _.length;
        $++
      ) {
    ...
    function W(A, p, _, N) {
      ...
      for (
        var w = null, it = null, J = p, $ = (p = 0), Qt = null, dt = _.next();
        J !== null && !dt.done;
        $++, dt = _.next()
      ) {
        J.index > $ ? ((Qt = J), (J = null)) : (Qt = J.sibling);
    ...
    function Et(A, p, _, N) {
      if (
        ...
        switch (_.$$typeof) {
          case O:
            t: {
              for (var w = _.key; p !== null; ) {
                if (p.key === w) {
                  if (((w = _.type), w === B)) {
                    if (p.tag === 7) {
                      l(A, p.sibling),
                        (N = n(p, _.props.children)),
                        (N.return = A),
                        (A = N);
                      break t;
                    }
          ...
          case D:
            t: {
              ...
              (N = bu(_, A.mode, N)), (N.return = A), (A = N);
            }
            return r(A);
          case rt:
            return (w = _._init), (_ = w(_._payload)), Et(A, p, _, N);
        }
        if (Rt(_)) return I(A, p, _, N);
        if (st(_)) {
          if (((w = st(_)), typeof w != "function")) throw Error(c(150));
          return (_ = w.call(_)), W(A, p, _, N);
        }
        if (typeof _.then == "function") return Et(A, p, ln(_), N);
        if (_.$$typeof === K) return Et(A, p, Zi(A, _), N);
        an(A, _);
      }
      return (typeof _ == "string" && _ !== "") ||
        ...
        ? ((_ = "" + _),
          p !== null && p.tag === 6
            ? (l(A, p.sibling), (N = n(p, _)), (N.return = A), (A = N))
            : (l(A, p), (N = Su(_, A.mode, N)), (N.return = A), (A = N)),
          r(A))
        : l(A, p);
    }
    return function (A, p, _, N) {
      try {
        Wa = 0;
        var w = Et(A, p, _, N);
        return (na = null), w;
  ...
  function Or(t, e, l, a, n) {
    ...
    return (
      ...
      t !== null && !Lt
        ? (Gu(t, e, n), Xe(t, e, n))
        : (gt && d && pu(e), (e.flags |= 1), Zt(t, e, a, n), e.child)
    );
  }
  ...
  function ef(t, e, l, a, n) {
    return (
      ...
      t !== null && !Lt
        ? (Gu(t, e, n), Xe(t, e, n))
        : (gt && a && pu(e), (e.flags |= 1), Zt(t, e, l, n), e.child)
    );
  }
  function Br(t, e, l, a, n, f) {
    return (
      ...
      t !== null && !Lt
        ? (Gu(t, e, f), Xe(t, e, f))
        : (gt && a && pu(e), (e.flags |= 1), Zt(t, e, l, f), e.child)
    );
  }
  ...
  function ud(t, e, l) {
    ...
    switch ((Eu(e), e.tag)) {
      ...
      case 27:
        ...
        return Ot(e), null;
      case 5:
        if ((pi(e), (l = e.type), t !== null && e.stateNode != null))
    ...
    do {
      if (n === 0) {
        ...
        t: {
          ...
          if ((e & 62914560) === e && ((n = pf + 300 - _e()), 10 < n)) {
            if ((cl(a, e, Se, !nl), Mi(a, 0, !0) !== 0)) break t;
            a.timeoutHandle = Ch(
              sh.bind(null, a, l, te, gn, bf, e, Se, Bl, ra, nl, f, 2, -0, 0),
              n
            );
            break t;
          }
          sh(a, l, te, gn, bf, e, Se, Bl, ra, nl, f, 0, -0, 0);
        }
      }
      break;
    } while (!0);
                ...
                if (T.getSelection) {
                  ...
                  if (
                    ...
                    _.setStart(A.node, A.offset),
                      x.removeAllRanges(),
                      W > Et
                        ? (x.addRange(_), x.extend(p.node, p.offset))
                        : (_.setEnd(p.node, p.offset), x.addRange(_));
                  }
                }
              }
            }
  ...
  function Sh() {
    if (Vt === 4 || Vt === 3) {
      ...
      (e.subtreeFlags & 10256) !== 0 || (e.flags & 10256) !== 0
        ? (Vt = 5)
        : ((Vt = 0), (ha = sl = null), bh(t, t.pendingLanes));
      ...
      if (
        ...
        try {
          le.onCommitFiberRoot(pa, e, void 0, (e.current.flags & 128) === 128);
        } catch {}
      if (a !== null) {
  ...
  function vd(t, e, l) {
    ...
    a !== null && a.delete(e),
      ...
      Mt === t &&
        (ct & l) === l &&
        (Ut === 4 || (Ut === 3 && (ct & 62914560) === ct && 300 > _e() - pf)
          ? (vt & 2) === 0 && oa(t, 0)
          : (Sf |= l),
        ra === ct && (ra = 0)),
      Oe(t);
  ...
  pe(fc, "onAnimationEnd"),
    pe(sc, "onAnimationIteration"),
    pe(cc, "onAnimationStart"),
    pe("dblclick", "onDoubleClick"),
    pe("focusin", "onFocus"),
    pe("focusout", "onBlur"),
    pe(j0, "onTransitionRun"),
    pe(Q0, "onTransitionStart"),
    pe(Z0, "onTransitionCancel"),
    pe(rc, "onTransitionEnd"),
  ...
  function Hf(t) {
    if (!t[pn]) {
      ...
      e === null || e[pn] || ((e[pn] = !0), Bf("selectionchange", !1, e));
    }
  }
  function Dh(t, e, l, a) {
    switch (t1(e)) {
          ...
          for (var p = M, _; p !== null; ) {
            ...
            if (
              ...
              (N !== 5 && N !== 26 && N !== 27) ||
                _ === null ||
                A === null ||
                ((N = Ta(p, A)), N != null && W.push(fi(p, N, _))),
              Et)
            )
              break;
            p = p.return;
        ...
        t: {
          ...
          if (
            ...
            if (
              ...
              (Et = x == null ? T : Ma(x)),
              (_ = I == null ? T : Ma(I)),
              (T = new W(N, p + "leave", x, l, R)),
              (T.target = Et),
              (T.relatedTarget = _),
              (N = null),
              Cl(R) === M &&
                ((W = new W(A, p + "enter", I, l, R)),
                (W.target = _),
                (W.relatedTarget = Et),
                (N = W)),
              (Et = N),
              ...
              e: {
                for (W = x, A = I, p = 0, _ = W; _; _ = va(_)) p++;
...
`
  ...
  function wt(t, e, l) {
    ...
    for (d in l)
      l.hasOwnProperty(d) && ((a = l[d]), a != null && pt(t, e, d, a, l, null));
  }
  function Od(t, e, l, a) {
    switch (e) {
      case "div":
          ...
          if (l.hasOwnProperty(x) && H != null)
            switch (x) {
              ...
              case "defaultValue":
                S = H;
              default:
                a.hasOwnProperty(x) || pt(t, e, x, null, a, H);
            }
        }
        for (var T in a) {
          var x = a[T];
          ...
          if (((S = l[f]), l.hasOwnProperty(f) && S != null))
            switch (f) {
              ...
              case "multiple":
                x = S;
              default:
                a.hasOwnProperty(f) || pt(t, e, f, null, a, S);
            }
        for (n in a)
          if (
            ((f = a[n]),
...
class Ct extends Array {
  ...
  distance(i) {
    return i ? bo(this, i) : bi(this);
  }
  squaredLen() {
    return S1(this);
  }
  squaredDistance(i) {
    return i ? po(this, i) : S1(this);
  }
  negate(i = this) {
    return Eo(this, i), this;
  }
  cross(i, s) {
    return s ? b1(this, i, s) : b1(this, this, i), this;
  }
  scale(i) {
...
class Bo {
  ...
  computeBoundingSphere(i) {
    ...
    for (let o = 0, g = s.length; o < g; o += c)
      p1.fromArray(s, o),
        (h = Math.max(h, this.bounds.center.squaredDistance(p1)));
...
function vg(u, i, s, c) {
  let h = bi([u[0], u[1], u[2]]);
  const o = bi([u[4], u[5], u[6]]),
    g = bi([u[8], u[9], u[10]]);
...
class vl extends Array {
  ...
  fromPerspective({ fov: i, aspect: s, near: c, far: h } = {}) {
    return bg(this, i, s, c, h), this;
  }
  fromOrthogonal({ left: i, right: s, bottom: c, top: h, near: o, far: g }) {
    return pg(this, i, s, c, h, o, g), this;
  }
  fromQuaternion(i) {
